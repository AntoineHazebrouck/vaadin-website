...
public class Backends
    ...
    private final Text item6 = new Text("");
    ...
    public void localeChange(LocaleChangeEvent event) {
        header.setText(getTranslation("about.hard-skills.backends.title"));
        item1.setText(getTranslation("about.hard-skills.backends.item1"));
        item2.setText(getTranslation("about.hard-skills.backends.item2"));
        item3.setText(getTranslation("about.hard-skills.backends.item3"));
        item4.setText(getTranslation("about.hard-skills.backends.item4"));
        item5.setText(getTranslation("about.hard-skills.backends.item5"));
        item6.setText(getTranslation("about.hard-skills.backends.item6"));
    }
}
