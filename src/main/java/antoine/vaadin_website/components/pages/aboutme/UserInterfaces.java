...
public class UserInterfaces
    ...
    public void localeChange(LocaleChangeEvent event) {
        header.setText(getTranslation("about.hard-skills.ui.title"));
        item1.setText(getTranslation("about.hard-skills.ui.item1"));
        item2.setText(getTranslation("about.hard-skills.ui.item2"));
        item3.setText(getTranslation("about.hard-skills.ui.item3"));
        item4.setText(getTranslation("about.hard-skills.ui.item4"));
    }
}
